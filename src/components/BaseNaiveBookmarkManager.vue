...
const handleCommit = async () => {
  ...
  try {
    ...
    console.error('[BaseNaiveBookmarkManager] flushConfigSync failed:', e)
  } finally {
...
<template>
  ...
  <div
    class="base-naive-bookmark-manager"
    :style="cssVars"
  >
    <!-- 键盘区域 -->
    <div class="naive-bookmark-manager-keyboard">
      <KeyboardLayout
        unit="px"
        :base-size="baseSize"
      ...
      >
        <template #keycap="{ code }">
          <div
            class="naive-bookmark-manager-keycap-drag-wrap"
            :class="{
              'naive-bookmark-manager-keycap-drag-wrap--drag-target':
                isDropTarget(code),
            }"
    ...
    <!-- 表单区域 -->
    <div class="naive-bookmark-manager-form">
...
.base-naive-bookmark-manager {
  ...
  /* ── 键盘区域 ── */
  .naive-bookmark-manager-keyboard {
    display: flex;
    justify-content: center;
  }

  .naive-bookmark-manager-keycap-drag-wrap {
    width: 100%;
    height: 100%;
