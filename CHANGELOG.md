...
## 🌟V1.21.x
- 新增：搜索组件支持配置是否在新标签页打开 https://github.com/GXFG/newtab-naivetab/issues/73
- 优化：样式优化
- 其他：依赖库升级
...
- 新增：键盘书签支持对外壳、定位板的配置，丰富配列
- 新增：配置书签支持从浏览器导入书签
- 新增：背景图新增Pexels源
- 新增：更多配置项；可以对喜欢的颜色进行收藏
- 优化：样式优化

## 🌟V1.18.x

- 新增：组件支持更多的配置项（分裂空格、更多颜色配置）
- 优化：配置项样式优化
- 修复：键盘书签HHKB样式错误；键盘配列同步错误 https://github.com/GXFG/newtab-naivetab/issues/55

## 🌟V1.17.x

- 新增：支持对页面打开时的默认聚焦元素进行自定义
- 新增：操作指南
- 新增：2024年法定假日数据
- 优化：组件样式优化
- 其他：“画布模式”重命名为“编辑布局”
...
- 优化：样式调整
- 修复：搜索栏、备忘录在画布模式下拖动异常
- 修复：搜索栏符号处理异常、小键盘回车触发搜索 https://github.com/GXFG/newtab-naivetab/issues/45
- 其他：依赖库升级，开发环境支持HMR
...
- 新增：更真实的键盘书签，包含多种键盘配列与键帽主题

## 🌟V1.8.1

- 优化：搜索框按键操作逻辑调整
- 修复：搜索框处于中文输入法时按下回车不会键入英文
- 修复：删除当前资源来源导致资讯展示空白
- 修复：万年历文案错误

## 🌟V1.8

- 新增：日历重命名为万年历；点击单日时增加了详细信息的展示；丰富万年历设置项
- 新增：新闻重命名为资讯；资讯来源增加了：今日头条、36氪、B站；丰富资讯设置项
- 修复：替换深色外观的默认背景图，防止因其可能会造成在低性能设备上使用时发生卡顿

## 🌟V1.7.5

- 新增：新增了一些字体，或许可以让时钟更加好看
- 优化：键盘特殊字符展示

## 🌟V1.7.4

- 优化：组件支持根据屏幕分辨率自动调整尺寸
